...
class UserSTopicModel
{
    public function SelectUserSTopic($Map)
    {
        try {
            $conn = GetDbByPdo();
            $Frist = true;
    ...
    public function AddUserSTopic($Map)
    {
        try {
            $conn = GetDbByPdo();
            $Frist = true;
    ...
    public function UpdateUserSTopic($Where, $Map)
    {
        try {
            $conn = GetDbByPdo();
            $Frist = true;
    ...
    public function DeleteUserSTopic($Map)
    {
        try {
            $conn = GetDbByPdo();
            $Frist = true;
