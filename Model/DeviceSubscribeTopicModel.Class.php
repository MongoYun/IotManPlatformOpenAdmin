...
class DeviceSubcribeTopicModel
{
    public function SelectDeviceSubscribeTopic($Map)
    {
        try {
            $conn = GetDbByPdo();
            $Frist = true;
    ...
    public function AddDeviceSubcribeTopic($Map)
    {
        try {
            $conn = GetDbByPdo();
            $Frist = true;
    ...
    public function UpdateDeviceSubcribeTopic($Where, $Map)
    {
        try {
            $conn = GetDbByPdo();
            $Frist = true;
    ...
    public function DeleteDeviceSubcribeTopic($Map)
    {
        try {
            $conn = GetDbByPdo();
            $Frist = true;
