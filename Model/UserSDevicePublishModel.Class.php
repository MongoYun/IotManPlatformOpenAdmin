 ...
 * Time: 15:25
 */
class UserSDevicePublishModel
{
    public function SelectUserSDevicePublish($Map)
    {
        try {
            $conn = GetDbByPdo();
            $Frist = true;
            ...
            $TableName = "PublishTopicCertificationControlList";
    ...
    public function AddUserSDevicePublish($Map)
    {
        try {
            $conn = GetDbByPdo();
            $Frist = true;
    ...
    public function UpdateUserSDevicePublish($Where, $Map)
    {
        try {
            $conn = GetDbByPdo();
            $Frist = true;
    ...
    public function DeleteUserSDevicePublish($Map)
    {
        try {
            $conn = GetDbByPdo();
            $Frist = true;
