 ...
 * Time: 15:25
 */
class UserSDeviceStatusModel
{
    public function SelectUserSDeviceStatus($Map)
    {
        try {
            $conn = GetDbByPdo();
            $Frist = true;
    ...
    public function AddUserSDeviceStatus($Map)
    {
        try {
            $conn = GetDbByPdo();
            $Frist = true;
    ...
    public function UpdateUserSDeviceStatus($Where, $Map)
    {
        try {
            $conn = GetDbByPdo();
            $Frist = true;
    ...
    public function DeleteUserSDeviceStatus($Map)
    {
        try {
            $conn = GetDbByPdo();
            $Frist = true;
