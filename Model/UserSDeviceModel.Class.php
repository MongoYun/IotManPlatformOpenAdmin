 ...
 * Time: 15:25
 */
class UserSDeviceModel
{
    public function SelectUserSDevice($Map)
    {
        try {
            $conn = GetDbByPdo();
            $Frist = true;
    ...
    public function AddUserSDevice($Map)
    {
        try {
            $conn = GetDbByPdo();
            $Frist = true;
    ...
    public function UpdateUserSDevice($Where, $Map)
    {
        try {
            $conn = GetDbByPdo();
            $Frist = true;
    ...
    public function DeleteUserSDevice($Map)
    {
        try {
            $conn = GetDbByPdo();
            $Frist = true;
