 ...
 * Time: 15:25
 */
class DeviceCertColModel
{
    public function SelectDeviceCertCol($Map)
    {
        try {
            $conn = GetDbByPdo();
            $Frist = true;
            ...
            $TableName = "DeviceCertificationControlList";
    ...
    public function AddDeviceCertCol($Map)
    {
        try {
            $conn = GetDbByPdo();
            $Frist = true;
    ...
    public function UpdateDeviceCertCol($Where, $Map)
    {
        try {
            $conn = GetDbByPdo();
            $Frist = true;
    ...
    public function DeleteDeviceCertCol($Map)
    {
        try {
            $conn = GetDbByPdo();
            $Frist = true;
